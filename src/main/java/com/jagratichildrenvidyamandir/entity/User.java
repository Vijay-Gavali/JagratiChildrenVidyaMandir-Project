...
public class User {
    ...
    public User(Integer userId, String name, String admissionNo, String admissionDate, String password,
            ...
            String caste, String subCaste, String religion, String apaarId, String panNo) {
        this.userId = userId;
        this.name = name;
    ...
    public ClassEntity getStudentClass() { return studentClass; }
    public void setStudentClass(ClassEntity studentClass) { this.studentClass = studentClass; }
